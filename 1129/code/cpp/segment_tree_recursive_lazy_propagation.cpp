...
public:
    ...
    int rangeResult = 0;
    vector<bool> lazyCheckList;
    vector<int> lazyValueList;
    int defaultValue;
    ...
    SegmentTree (vector<int>* inputList, string calculationMethod) {
        ...
        this->lazyCheckList = vector<bool>(this->length, false);
        this->lazyValueList = vector<int>(this->length, 0);
    ...
    int rangeNode(int updateValue, int updateRange) {
        if (this->calculationMethod == "sum") {
    ...
    int pushDown(int updateValue, int treeIndex, int inputStartIndex, int inputEndIndex) {
    ...
    int updateProcess(int updateStartIndex, int updateEndIndex, int updateValue, int inputStartIndex, int inputEndIndex, int treeIndex) {
    ...
    void updateRange(int updateStartIndex, int updateEndIndex, int updateValue) {
        this->treeIndex = 1;
